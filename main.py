...
def filter_properties(properties: list):
    return filter(
        lambda property : 
            property[csv_headers.TAX_PRICE.value] * 1.05 >= property[csv_headers.PRICE.value] if property[csv_headers.TAX_PRICE.value] and property[csv_headers.PRICE.value] else False,
        properties)
